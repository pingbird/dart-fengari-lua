...
@JS("lua.lua_getinfo")           external int        lua_getinfo(lua_State L, dynamic, lua_Debug ar);
...
@JS("lua.lua_isyieldable")       external bool       lua_isyieldable(lua_State L, int index);
...
@JS("lua.lua_rawlen")            external void       lua_rawlen(lua_State L, int index);
...
@JS("lauxlib.luaL_requiref")      external void luaL_requiref(lua_State L, dynamic modname, dynamic openf, int glb);
...
@JS("lualib.luaL_openlibs")     external dynamic luaL_openlibs(lua_State L);
@JS("lualib.luaopen_base")      external dynamic luaopen_base(lua_State L);
@JS("lualib.luaopen_coroutine") external dynamic luaopen_coroutine(lua_State L);
@JS("lualib.luaopen_debug")     external dynamic luaopen_debug(lua_State L);
@JS("lualib.luaopen_fengari")   external dynamic luaopen_fengari(lua_State L);
@JS("lualib.luaopen_math")      external dynamic luaopen_math(lua_State L);
@JS("lualib.luaopen_os")        external dynamic luaopen_os(lua_State L);
@JS("lualib.luaopen_package")   external dynamic luaopen_package(lua_State L);
@JS("lualib.luaopen_string")    external dynamic luaopen_string(lua_State L);
@JS("lualib.luaopen_table")     external dynamic luaopen_table(lua_State L);
@JS("lualib.luaopen_utf8")      external dynamic luaopen_utf8(lua_State L);
